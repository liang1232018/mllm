...
public:
     ...
     */
    explicit QNNGraph(const express::NetParameter &param, Backend *bn, unordered_map<string, shared_ptr<Tensor>> &external_tensors, int threadCount, string graphName = "");

...
TEST_F(XpTest, XpDyanmicShape) {
    ...
    Tensor inputs_1(1, 1, 16, 2048, Context::Instance().globalBackends(MLLM_XNNPACK), true);
    Tensor outputs_1(1, 1, 16, 1024, Context::Instance().globalBackends(MLLM_XNNPACK), true);
    ...
    Tensor inputs_2(1, 1, 32, 2048, Context::Instance().globalBackends(MLLM_XNNPACK), true);
    Tensor outputs_2(1, 1, 32, 1024, Context::Instance().globalBackends(MLLM_XNNPACK), true);

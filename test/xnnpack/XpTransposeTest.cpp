...
TEST_F(XpTest, TransposeModule) {
    ...
    EXPECT_EQ(Context::Instance().globalBackends(MLLM_XNNPACK) != nullptr, true);
    ...
    // B, S ,H, D
    Tensor x(1, 6, 8, 1, Context::Instance().globalBackends(MLLM_XNNPACK), true);
...
TEST(TransposeTest, RawXnnImpl) {
    ...
    // B, S, H, D
    Tensor x(1, 1, 2048, 1024, Context::Instance().globalBackends(MLLM_XNNPACK), true);
    ...
    Tensor out(1, 1, 2048, 4096, Context::Instance().globalBackends(MLLM_XNNPACK), true);
    ...
    // create linear
    Tensor weight(1, 1, 1024, 4096, Context::Instance().globalBackends(MLLM_XNNPACK), true);
    Tensor bias(1, 1, 1, 4096, Context::Instance().globalBackends(MLLM_XNNPACK), true);
